...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.productApprove.update',$product->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <a  class="btn btn-danger m-t-15 waves-effect" href="{{ route('admin.productApprove.index') }}">BACK</a>
